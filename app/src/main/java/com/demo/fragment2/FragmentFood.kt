...
import com.demo.databinding.FragmentFoodBinding
...
class FragmentFood : Fragment() {
    ...
    private val collection = firestore.collection("food")
    ...
    override fun onViewCreated(
        ...
        binding.recycleFood.layoutManager = GridLayoutManager(requireContext(), 4)
        gridItemAdapter = GridItemAdapter()
        binding.recycleFood.adapter = gridItemAdapter
