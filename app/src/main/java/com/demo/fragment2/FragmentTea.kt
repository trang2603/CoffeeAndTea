...
class FragmentTea : Fragment() {
    ...
    override fun onViewCreated(
        ...
        binding.recycleViewTea.layoutManager = GridLayoutManager(requireContext(), 4)
        gridItemAdapter = GridItemAdapter()
        binding.recycleViewTea.adapter = gridItemAdapter
